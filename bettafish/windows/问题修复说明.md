...
**旧代码逻辑** ([docker-deploy-v4.ps1:682-683](docker-deploy-v4.ps1#L682-L683)):
```powershell
...
**新代码逻辑** ([docker-deploy-v4.ps1:682-727](docker-deploy-v4.ps1#L682-L727)):
```powershell
...
→ **解决**: 运行最新版 `docker-deploy-v4.bat`,已修复镜像拉取问题
